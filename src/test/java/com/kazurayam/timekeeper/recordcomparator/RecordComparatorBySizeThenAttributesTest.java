...
public class RecordComparatorBySizeThenAttributesTest {
    ...
    public void test_smoke() {
        RecordComparatorBySizeThenAttributes comparator =
                new RecordComparatorBySizeThenAttributes(Arrays.asList("URL"));
