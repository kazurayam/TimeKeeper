...
public class RecordComparatorByAttributesThenDurationTest {
    ...
    public void test_smoke() {
        RecordComparatorByAttributesThenDuration comparator =
                new RecordComparatorByAttributesThenDuration(Arrays.asList("URL"));
        Record left = records.get(0);
        Record right = records.get(3);
