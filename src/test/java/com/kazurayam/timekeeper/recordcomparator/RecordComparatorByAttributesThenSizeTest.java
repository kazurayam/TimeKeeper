...
public class RecordComparatorByAttributesThenSizeTest {
    ...
    public void test_smoke() {
        RecordComparatorByAttributesThenSize comparator =
                new RecordComparatorByAttributesThenSize(Arrays.asList("URL"));
